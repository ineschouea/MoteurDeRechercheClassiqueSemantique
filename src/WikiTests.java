...
public class WikiTests
{
   public static void main(String[] args) throws IOException {
        ...
        // getCategories()
        for (String cat : enWiki.getCategories("Carabus_intricatus"))
            System.out.println(cat);

        /*System.out.println(enWiki.getPageText("Tunisia"));
        ...
        // see also issue 39
        Map<String, Object> blah5[] = enWiki.getPageInfo(new String[] { "Template:La", "Template:La", "Zombie", "Ksdhfsjk", "Cre" });
...
*/
        ...
        String msg= enWiki.getPageText("Tunisia");
